...
class StudentMemory:
    ...
    def retrieve_long_term(self, user_id: str, thread_id: str, query: str) -> str:
        ...
        parts = [getattr(user_context, "context", "") or ""]
        try:
            ...
            # The Context Block is the required long-term source. Edge search is
            # supplementary, so a transient graph-search failure must not erase it.
            pass
